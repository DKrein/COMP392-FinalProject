...
(function (scenes) {
     ...
     */
    var PreLevel3 = (function (_super) {
        __extends(PreLevel3, _super);
        /**
         * Empty Contructor
         *
         * @constructor
        ...
        PreLevel3.prototype._setupCanvas = function () {
         ...
         * @return void
         */
        PreLevel3.prototype._initialize = function () {
         ...
         * @return void
         */
        PreLevel3.prototype.start = function () {
            var _this = this;
            ...
            this._auxImage = new createjs.Bitmap(assets.getResult("PreLevel3"));
         ...
         * @return void
         */
        PreLevel3.prototype.checkShortcut = function () {
         ...
         * @return void
         */
        PreLevel3.prototype._removeAllListeners = function () {
         ...
         * @return void
         */
        PreLevel3.prototype.update = function () {
            this.checkShortcut();
            this._stage.update();
        };
        /**
         ...
         * @return void
         */
        PreLevel3.prototype.resize = function () {
            this._setupCanvas();
        };
        return PreLevel3;
    }(scenes.Scene));
    scenes.PreLevel3 = PreLevel3;
})(scenes || (scenes = {}));

//# sourceMappingURL=prelevel3.js.map
