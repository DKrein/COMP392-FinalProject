...
(function (scenes) {
     ...
     */
    var PreLevel1 = (function (_super) {
        __extends(PreLevel1, _super);
        /**
         * Empty Contructor
         *
         * @constructor
        ...
        PreLevel1.prototype._setupCanvas = function () {
         ...
         * @return void
         */
        PreLevel1.prototype._initialize = function () {
         ...
         * @return void
         */
        PreLevel1.prototype.start = function () {
            var _this = this;
         ...
         * @return void
         */
        PreLevel1.prototype.checkShortcut = function () {
         ...
         * @return void
         */
        PreLevel1.prototype._removeAllListeners = function () {
         ...
         * @return void
         */
        PreLevel1.prototype.update = function () {
            this.checkShortcut();
            this._stage.update();
        };
        /**
         ...
         * @return void
         */
        PreLevel1.prototype.resize = function () {
            this._setupCanvas();
        };
        return PreLevel1;
    }(scenes.Scene));
    scenes.PreLevel1 = PreLevel1;
})(scenes || (scenes = {}));

//# sourceMappingURL=prelevel1.js.map
